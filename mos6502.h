...
private:
    ...
    static const uint16_t irqVectorH = 0x7FFF;
    static const uint16_t irqVectorL = 0x7FFE;
    static const uint16_t rstVectorH = 0x7FFD;
    static const uint16_t rstVectorL = 0x7FFC;
    static const uint16_t nmiVectorH = 0x7FFB;
    static const uint16_t nmiVectorL = 0x7FFA;
...
public:
    ...
    void IRQ();
    void Reset();
    void Run(uint32_t n, MainWindow *mainWindow);
};
